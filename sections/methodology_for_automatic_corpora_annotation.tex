...
\fbox {
    \parbox{\linewidth}{
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item[] si la phrase est entourée par du nouveau contenu dans la réponse, l'étiquette est \texttt{\footnotesize Start\&End}
                \item[] sinon si la phrase est précédée par du nouveau contenu, l'étiquette est \texttt{\footnotesize Start}
                \item[] sinon si la phrase est suivie par du nouveau contenu, l'étiquette est \texttt{\footnotesize End}
                \item[] sinon, l'étiquette est \texttt{\footnotesize Inside}
            \end{itemize}
        \end{itemize}
        \vspace{3mm}
    }
